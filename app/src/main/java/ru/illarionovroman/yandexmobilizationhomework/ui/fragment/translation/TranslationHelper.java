...
public class TranslationHelper {
     ...
     * @param params {@link TranslationParams} which contains all required information to perform translation
     ...
     */
    private static Single<HistoryItem> loadHistoryItemFromNetwork(final Context context, final RestApi restApi,
                                                                  TranslationParams params) {
        String langFromTo = buildTranslationLangParam(context,
                params.getLanguageCodeFrom(),
                params.getLanguageCodeTo());

        Single<HistoryItem> historyItemSingle = restApi.getTranslation(params.getWordToTranslate(), langFromTo, null)
